...
public class HeadAndFootAdapter extends SimpleListAdapter<String> {
    ...
    public void addHeader() {
        View header = getInflater().inflate(R.layout.item_header_footer, null);
        ((TextView) header.findViewById(R.id.tv2)).setText(++index + "头布局");
        addHeaderView(header);
    }

    public void addFooter() {
        View footer = getInflater().inflate(R.layout.item_header_footer, null);
        ((TextView) footer.findViewById(R.id.tv2)).setText(++index2 + "脚布局");
